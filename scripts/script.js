const popupEdit = document.querySelector('.popup__edit-button');
const edit = document.querySelector('.profile__edit-button');
const closed = document.querySelector('.popup__closed');
const popupAdd = document.querySelector('.popup__add-button');
const formElementAdd = popupAdd.querySelector('.popup__form');
const formElementEdit = popupEdit.querySelector('.popup__form');
const popupTypeImage = document.querySelector('.popup__type-image');
